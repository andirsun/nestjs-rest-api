...
/*
automaticPayment = new NequiAutomaticPayment();
automaticPayment.setPhoneNumber('3162452663');
automaticPayment.setToken('ZGFiNTQxNzAtZjcyZS0xMzhiLWU0ZGYtZDMyNmYyMDdhNThm');
automaticPayment.setValue('13000');
automaticPayment.setReference1('Corte de pelo + barba');
automaticPayment.setReference2('50% Off');
console.log(JSON.stringify(automaticPayment.getRequest()));
*/
